package com.sample.feedpresentation.mockData
...
internal object MockDataProvider {
    ...
    val episode1 =
        Episode(id = Id(value = 1),
            name = Name(value = "Pilot"),
            date = "December 2, 2013",
            code = "S01E01")
    val episode2 = Episode(id = Id(value = 2),
        name = Name(value = "Lawnmower Dog"),
    ...
    val rickWithEpisodes = CharacterDetail(
        rick,
